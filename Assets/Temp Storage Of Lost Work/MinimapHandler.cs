...
public class MinimapHandler : MonoBehaviour
{
    ...
    {
        GameObject Newicon = (GameObject)Instantiate(Resources.Load($"Icons/{owner} Campfire Icon"), icon.transform.position, icon.transform.rotation, icon.transform.parent);
        SetLayer(Newicon);
        icons.Add(Newicon);
